...
/usr/bin/time psql -U ${DBOWNER} -d ${PGDATABASE} -f trimet_stop_event.sql \
 -v schema=y2018_m04 -v trimet_stop_event_csv="'/csvs/trimet_stop_event 1-30APR2018.csv'"

/usr/bin/time psql -U ${DBOWNER} -d ${PGDATABASE} -f trimet_stop_event.sql \
 -v schema=y2018_m05 -v trimet_stop_event_csv="'/csvs/trimet_stop_event 1-31MAY2018.csv'"
