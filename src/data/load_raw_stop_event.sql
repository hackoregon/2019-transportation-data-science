...
COPY raw_stop_event FROM '/Work/raw_stop_event_2018_07.csv' WITH csv header;
COPY raw_stop_event FROM '/Work/raw_stop_event_2018_08.csv' WITH csv header;
...
COPY raw_stop_event FROM '/Work/raw_stop_event_2019_04.csv' WITH csv header;
