...
/usr/bin/time psql -U ${DBOWNER} -d ${PGDATABASE} -f init_tripsh.sql \
 -v schema=y2018_m04 -v init_tripsh_csv="'/csvs/init_tripsh 1-30APR2018.csv'"
/usr/bin/time psql -U ${DBOWNER} -d ${PGDATABASE} -f init_veh_stoph.sql \
 -v schema=y2018_m04 -v init_veh_stoph_csv="'/csvs/init_veh_stoph 1-30APR2018.csv'"

/usr/bin/time psql -U ${DBOWNER} -d ${PGDATABASE} -f init_tripsh.sql \
 -v schema=y2018_m05 -v init_tripsh_csv="'/csvs/init_tripsh 1-31MAY2018.csv'"
/usr/bin/time psql -U ${DBOWNER} -d ${PGDATABASE} -f init_veh_stoph.sql \
 -v schema=y2018_m05 -v init_veh_stoph_csv="'/csvs/init_veh_stoph 1-31MAY2018.csv'"
