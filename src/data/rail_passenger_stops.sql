...
CREATE TABLE rail_passenger_stops_y2018m07
PARTITION OF rail_passenger_stops
FOR VALUES FROM ('2018-07-01') TO ('2018-08-01');

CREATE TABLE rail_passenger_stops_y2018m08
PARTITION OF rail_passenger_stops
...
CREATE TABLE rail_passenger_stops_y2019m04
PARTITION OF rail_passenger_stops
FOR VALUES FROM ('2019-04-01') TO ('2019-05-01');

CREATE TABLE rail_passenger_stops_y2019m05
PARTITION OF rail_passenger_stops
FOR VALUES FROM ('2019-05-01') TO ('2019-06-01');

CREATE TABLE rail_passenger_stops_y2019m06
PARTITION OF rail_passenger_stops
FOR VALUES FROM ('2019-06-01') TO ('2019-07-01');

CREATE TABLE rail_passenger_stops_y2019m07
PARTITION OF rail_passenger_stops
