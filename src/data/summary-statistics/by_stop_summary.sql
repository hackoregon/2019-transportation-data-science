...
CREATE TABLE bus_by_stop_summary AS
  SELECT location_id, stop_name, route_number, direction, passenger_stop_locations.longitude,
  ...
  WHERE service_key = 'W'
  GROUP BY location_id, stop_name, route_number, direction, arrive_quarter_hour,
