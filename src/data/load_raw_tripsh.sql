...
COPY raw_tripsh FROM '/Work/raw_tripsh_2018_07.csv' WITH csv header;
COPY raw_tripsh FROM '/Work/raw_tripsh_2018_08.csv' WITH csv header;
...
COPY raw_tripsh FROM '/Work/raw_tripsh_2019_04.csv' WITH csv header;
