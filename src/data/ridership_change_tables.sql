...
DELETE FROM riders_2010 WHERE ons_2010 < 1000 OR offs_2010 < 1000;
...
GROUP BY location_id;
DELETE FROM riders_2017 WHERE ons_2017 < 1000 OR offs_2017 < 1000;

DROP TABLE IF EXISTS ridership_deltas;
CREATE TABLE ridership_deltas AS
SELECT riders_2017.location_id,
...
FROM riders_2017 INNER JOIN riders_2010 ON riders_2010.location_id = riders_2017.location_id
