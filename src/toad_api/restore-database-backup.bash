...
pg_restore --verbose --jobs=4 --dbname=transit_operations_analytics_data --username=transportation2019 \
  transit_operations_analytics_data.backup
sudo su - postgres -c "psql -d transit_operations_analytics_data -c '\d+'"
