...
gc()
extra_columns <- c("OPD_DATE.y", "VEHICLE_ID.y", "METERS.y", "ACT_DEP_TIME.y",
                   "NOM_DEP_TIME.y", "NOM_END_TIME", "ACT_END_TIME") 
vehicle_stop_history <- vehicle_stop_history[, (extra_columns) := NULL]
