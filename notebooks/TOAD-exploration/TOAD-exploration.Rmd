...
bus_passenger_stops_summary <- bus_passenger_stops[
  , .(
    ...
    p05_seconds = qx(SECONDS_BETWEEN_STOPS, 0.05),
    p25_seconds = qx(SECONDS_BETWEEN_STOPS, 0.25),
    p50_seconds = qx(SECONDS_BETWEEN_STOPS, 0.50),
    p75_seconds = qx(SECONDS_BETWEEN_STOPS, 0.75),
    p95_seconds = qx(SECONDS_BETWEEN_STOPS, 0.95)
  ),
