...
stop_to_stop_seconds <- vehicle_stop_history[
  , .(
    .N,
    mean = mean(SECONDS_TRAVELED),
    cvar = sd(SECONDS_TRAVELED) / mean(SECONDS_TRAVELED),
...
gc()
stop_to_stop_seconds <- stop_to_stop_seconds[N > 30]
gc()
...
stop_to_stop_meters <- vehicle_stop_history[
  , .(
    .N,
    mean = mean(METERS_TRAVELED),
    cvar = sd(METERS_TRAVELED) / mean(METERS_TRAVELED),
...
gc()
stop_to_stop_meters <- stop_to_stop_meters[N > 30]
gc()
