...
stop_locations <- SpatialPointsDataFrame(
  coords = stop_locations[, X_COORDINATE_2913:Y_COORDINATE_2913],
  data = stop_locations,
  proj4string = CRS("+init=epsg:2913"))
gc()
stop_locations <- spTransform(stop_locations, CRS("+init=epsg:4326"))
gc()
stop_locations <- as(stop_locations, "sf")
gc()
